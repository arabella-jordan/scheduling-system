    ...
    @endif
        ...
        <div class="rounded-md shadow-sm">
            <select multiple
                ...
                class="block w-full transition duration-150 ease-in-out border-gray-300 rounded-md shadow-sm focus:border-slate-300 focus:ring focus:ring-slate-200 focus:ring-opacity-50 dark:bg-gray-800 dark:text-white dark:border-gray-600"
            >
