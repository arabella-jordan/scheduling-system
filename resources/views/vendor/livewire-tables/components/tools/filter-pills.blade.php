                ...
                @foreach($component->getAppliedFiltersWithValues() as $filterSelectName => $value)
                    ...
                    @else
                        <span
                            ...
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-slate-100 text-slate-800 capitalize dark:bg-slate-200 dark:text-slate-900"
                        >
                            ...
                            <button
                                ...
                                type="button"
                                class="flex-shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center text-slate-400 hover:bg-slate-200 hover:text-slate-500 focus:outline-none focus:bg-slate-500 focus:text-white"
                            >
